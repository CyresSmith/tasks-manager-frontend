...
document.body.style.fontFamily = myTheme.fonts.body;
document.body.style.fontSize = myTheme.fontSizes.m;
document.body.style.color = myTheme.colors.text;
document.body.style.backgroundColor = myTheme.colors.background;
